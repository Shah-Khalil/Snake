...
function draw(){
    ...
    // ctx.drawImage(pixelSnake,pixel.x,pixel.y);
    // console.log(pixelSnake)
    //  console.log(img)
    ...
    for( let i = 0; i < snake.length ; i++){
        ...
        // ctx.drawImage(pixelSnake,snake[i].x,snake[i].y);
        // ctx.strokeStyle = "red";
    ...
    // if( b == "LEFT" ) snakeX -= box;
    // if( b == "UP" ) snakeY -= box;
    // if( b == "RIGHT" ) snakeX += box;
    // if( b == "DOWN" ) snakeY += box;
